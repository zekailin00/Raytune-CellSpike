...
#SBATCH -N2 -c 10 --ntasks-per-node=3 -G 7
...
python ./train_RayTune.py --dataPath /global/homes/b/balewski/prjn/neuronBBP-pack40kHzDisc/probe_quad/bbp153 --probeType quad -t 8000 --useDataFrac 1 --steps 10 --rayResult $SCRATCH/ray_results --numHparams 20